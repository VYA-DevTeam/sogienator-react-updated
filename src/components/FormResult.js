    ...
    <div className="form-container">
      <div className="d-flex flex-column">
        <div className="fb-form justify-content-center">
          ...
          <div className="fb-card-header p-3">Đánh giá Sogienator</div>
          <form
            className="d-flex flex-column bd-highlight form-feedback"
            onSubmit={(e) => handleSubmit(e)}
          >
            <div className="fb-content px-2 pt-3 text-center">
              1, Trải nghiệm về kết quả
            </div>
            <div className="list-feedback px-3 pt-4 mr-1">
              <div
                className="first-q"
            ...
            {/* </div> */}
            {/* </div> */}
            <div className="fb-content px-4 pb-4 text-center">
              3, Bạn còn điều gì muốn bày tỏ hoặc góp ý chi tiết thêm với Vy An
              không?{" "}
            </div>
            <div
              className="first-q"
            ...
            >
              ...
              <div
                className="p-3 bd-highlight fb-text "
                onClick={(e) => handleClick(e)}
                id="additional"
                value={data.additional}
              >
